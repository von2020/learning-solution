...
@Component({
  selector: 'app-edit-course-material',
  templateUrl: './edit-course-material.component.html',
  styleUrls: ['./edit-course-material.component.css'],
})
export class EditCourseMaterialComponent implements OnInit {
